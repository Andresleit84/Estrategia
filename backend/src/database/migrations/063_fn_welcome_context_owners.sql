-- Migration 063: fn_welcome_context con owner_name en todos los widgets
-- Actualizado 2026-05-29: owner_name en my_objectives, obj_owner_name en pending_checkins,
-- kr_owner_name en at_risk_krs. Requiere 3 parámetros (p_cycle_id opcional).
  ...
  SELECT json_build_object(
    ...
    'active_cycle', (
      SELECT json_build_object(
        ...
        'avg_confidence', (
          SELECT ROUND(AVG(kr.confidence)::NUMERIC, 2)
          FROM key_results kr
          JOIN objectives o ON kr.objective_id = o.id
          WHERE o.organization_id = p_org_id
            AND o.cycle_id = v_cycle_id
