-- ── Migración 034: fn_welcome_context con parámetro de ciclo opcional ────────
-- Permite filtrar toda la pantalla de inicio por un ciclo específico.
-- Si p_cycle_id es NULL → comportamiento anterior (ciclo activo prioritario).
...
BEGIN
  ...
  SELECT json_build_object(
    ...
    -- Estadísticas del ciclo seleccionado
    'org_stats', (
      SELECT json_build_object(
