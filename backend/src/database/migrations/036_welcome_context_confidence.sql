-- ── Migración 036: fn_welcome_context — añade avg_confidence al ciclo ─────────
-- Agrega el promedio de confianza de los KRs activos del ciclo seleccionado
-- como campo avg_confidence en active_cycle (0.0–1.0, null si no hay KRs).
