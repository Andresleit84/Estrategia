...
import {
  ...
  Stethoscope, Briefcase, Map, Handshake, Route, MonitorPlay, User, BellRing, Shield, Building2, CalendarRange,
} from "lucide-react";
...
const NAV_ITEMS: NavItemDef[] = [
  ...
  { key: "planning",           href: "/planning",            icon: CalendarRange,     tKey: "planning",         group: "execution",  desc: "Revisión Trimestral del Negocio — 11 etapas de planificación" },
...
const DEFAULT_MENU_CONFIG: Record<string, Record<string, boolean>> = {
  ADMIN: {
    ...
    planning: true,  delivery: true,  backlog: true,  sprints: true,  reports: true,
  ...
  MANAGER: {
    ...
    planning: true,  delivery: true,  backlog: true,  sprints: false,  reports: true,
  ...
  MEMBER: {
    ...
    planning: false,  delivery: true,  backlog: true,  sprints: true,  reports: false,
  ...
  VIEWER: {
    ...
    planning: false,  delivery: true,  backlog: true,  sprints: false,  reports: true,
    portfolio: false,  "ai-assistant": false,  consejo: false,
  },
  SECTOR_DIAGNOSTICS: {
    ...
    planning: false,  delivery: false,  backlog: false,  sprints: false,  reports: false,
    portfolio: false,  "ai-assistant": false,  consejo: false,
  },
};
...
const PLAN_MODULES: Record<string, Set<string>> = {
  ...
  PRO: new Set([
    ...
    "tactical", "checkins", "initiatives", "planning", "delivery", "backlog", "sprints",
